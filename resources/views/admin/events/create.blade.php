            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('global.event.add')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('global.event.add')</h4>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-group mb-0 justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">@lang('global.event.save')</button>
                            </div>
                        </div>                        
                    </div>
                </div>
