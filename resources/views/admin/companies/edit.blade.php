            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('user_control.company.edit_title')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('user_control.company.edit_title')</h4>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" maxlength="50" class="form-control" name="company_code" value="{{ $company->company_code }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" maxlength="50" class="form-control" name="company_name" value="{{ $company->company_name }}">
                        ...
                        <div class="form-group mb-0 justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">@lang('user_control.company.change')</button>
                            </div>
                        </div>                        
                    </div>
                </div>
