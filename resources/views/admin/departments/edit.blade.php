            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('user_control.department.edit_title')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('user_control.department.edit_title')</h4>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" maxlength="50" class="form-control" name="department_name" value="{{ $department->department_name }}">
                        ...
                        <div id="customerDiv" class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('company_name', $companies, $department->company_id, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group mb-0 justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">@lang('user_control.department.change')</button>
                            </div>
                        </div>                        
                    </div>
                </div>
