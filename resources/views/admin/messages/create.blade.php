            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('dashboard.message.add')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('dashboard.message.add')</h4>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="admin_title" value="{{ old('admin_title') }}" maxlength="255">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="admin_message" value="{{ old('admin_message') }}" maxlength="255">
