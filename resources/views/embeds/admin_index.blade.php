                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('embeds.index') }}"><i class="fe-box"></i><span> @lang('global.embed.title') </span></a>
                        </li>
                        <li class="breadcrumb-item active">Forms Acknowledgement View</li>
                    </ol>
                </div>
                <h4 class="page-title">Forms Acknowledgement View</h4>
            </div>
        </div>
    </div>
...
{{--        <input type="text" id="range-datepicker" class="form-control text-center" value="{{ date('Y-m-01')." to ". date('Y-m-d') }}" style="width: 250px; font-size: 15px;" id="dtstart" name="dtstart" />--}}
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url('/embeds/history/1') }}" method="get">
            ...
            <div id="cardCollpase1" class="collapse pt-3 show">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-xs-12 mb-3">
                            <label class="col-md-3 col-form-label text-left" for="form_name">Form Name</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="form_name" id="form_name" value="{{ isset($request->form_name)?$request->form_name:'' }}" maxlength="50">
                            </div>
                        </div>
                    </div>
                </div>
