                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">
                            <span> @lang('document.edit') </span>
                        </li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('document.edit')</h4>
            </div>
        </div>
    </div>
    <div class="card">
                ...
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="docu_name" id="docu_name" value="{{ $document->docu_name }}" maxlength="50">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="docu_no" id="docu_no" value="{{ $document->docu_no }}" maxlength="50">
...
@section('javascript')
    <script>
        ...
        function chengeCompany() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (firstFlag == true)
                    {
                        $('#department').val("{{ $document->depart_id }}");
                        firstFlag = false;
                    }
                }
            });
        ...
        $(document).ready(function () {
           $('#company').val("{{ $document->company_id }}");
           $('#category').val("{{ $document->category_id }}");
            chengeCompany();
        });
    </script>
@endsection
