...
<div class="row">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('dashboard.memo.edit')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('dashboard.memo.edit')</h4>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('memos.update', $one->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-group mb-0 justify-content-end row">
                            <div class="col-9">
                                <button type="submit" class="btn btn-block btn-primary waves-effect waves-light">@lang('dashboard.memo.change')</button>
                            </div>
                        </div>                        
                    </div>
                </div>
